...
{
	ssd1306_command(SSD1306_RIGHT_HORIZONTAL_SCROLL); // send 0x26
	ssd1306_command(0X00); // send dummy
	ssd1306_command(start); // start page address
	ssd1306_command(0X00);  // time interval 5 frames
	ssd1306_command(stop); // end page address
	ssd1306_command(0X00);
	ssd1306_command(0XFF);
	ssd1306_command(SSD1306_ACTIVATE_SCROLL); // start scroll
}
...
{
	ssd1306_command(SSD1306_LEFT_HORIZONTAL_SCROLL); // send 0x26
	ssd1306_command(0X00); // send dummy
	ssd1306_command(start); // start page address
	ssd1306_command(0X00); // time interval 5 frames
	ssd1306_command(stop); // end page address
...
{
	ssd1306_command(SSD1306_SET_VERTICAL_SCROLL_AREA); // sect the area
	ssd1306_command(0X00); // write dummy
